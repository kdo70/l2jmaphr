...
public final class Config {
    ...
    public static int BUFF_PRICE_PER_UNIT;
     ...
     */
    public static int CHAMP_CHANCE;
    public static int CHAMP_MIN_LVL;
    public static int CHAMP_MAX_LVL;

    public static double CHAMP_MUL_HP;
    public static double CHAMP_MUL_ATK;
    public static double CHAMP_MUL_ATK_SPD;

    public static double CHAMP_MUL_EXP;
    public static double CHAMP_MUL_SP;
    public static double CHAMP_MUL_ADENA;
    public static double CHAMP_MUL_ITEMS;
    public static double CHAMP_MUL_SPOIL;

    public static int CHAMP_ITEM_DROP_CHANCE;
    public static int CHAMP_ITEM_DROP_ID;
    public static int CHAMP_ITEM_DROP_COUNT;

    /**
     * Shift + click command npc
     */
    ...
    private static final void loadNpcs() {
        ...
        BUFF_PRICE_PER_UNIT = npcs.getProperty("BuffPricePerUnit", 0);
        FREE_TELEPORT = npcs.getProperty("FreeBuffer", false);
        FREE_TELEPORT_LVL = npcs.getProperty("FreeBufferLvl", 0);
        BUFF_PRICE_PER_UNIT = npcs.getProperty("BuffPricePerUnit", 1);
        ...
        CHAMP_CHANCE = npcs.getProperty("ChampChance", 0);
        CHAMP_MIN_LVL = npcs.getProperty("ChampMinLvl", 1);
        CHAMP_MAX_LVL = npcs.getProperty("ChampMaxLvl", 90);

        CHAMP_MUL_HP = npcs.getProperty("ChampMulHp", 1.);
        CHAMP_MUL_ATK = npcs.getProperty("ChampMulAtk", 1.);
        CHAMP_MUL_ATK_SPD = npcs.getProperty("ChampMulAtkSpd", 1.);

        CHAMP_MUL_EXP = npcs.getProperty("ChampMulExp", 1.);
        CHAMP_MUL_SP = npcs.getProperty("ChampMulSp", 1.);
        CHAMP_MUL_ADENA = npcs.getProperty("ChampMulAdena", 1.);
        CHAMP_MUL_ITEMS = npcs.getProperty("ChampMulItems", 1.);
        CHAMP_MUL_SPOIL = npcs.getProperty("ChampMulSpoil", 1.);

        CHAMP_ITEM_DROP_CHANCE = npcs.getProperty("ChampItemDropChance", 0);
        CHAMP_ITEM_DROP_ID = npcs.getProperty("ChampItemDropId", 57);
        CHAMP_ITEM_DROP_COUNT = npcs.getProperty("ChampItemDropCount", 1);

        // Modification: Shift + click command npc
        ALT_GAME_VIEWNPC = npcs.getProperty("EnableNpcDropViewer", true);
    }
